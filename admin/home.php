                                                    ...
                                                    <div class="col-xl-4 col-md-6">
                                                        <div class="card comp-card">
                                                            <div class="card-body">
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        <h6 class="m-b-20">Alianzas</h6>
                                                                        <h3 class="text-c-green">
                                                                            <span id="alianzas">0</span> +
                                                                        </h3>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <i class="feather icon-award text-success" style="font-size: 32px"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-xl-4 col-md-6">
                                                        <div class="card comp-card">
                                                            <div class="card-body">
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        <h6 class="m-b-20">Empresas</h6>
                                                                        <h3 class="text-c-yellow">
                                                                            <span id="empresas">0</span> +
                                                                        </h3>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        ...
                                                                        <h3 class="text-c-blue">
                                                                            <span id="servicios">0</span> +
                                                                        </h3>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <i class="feather icon-clipboard text-primary" style="font-size: 32px"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

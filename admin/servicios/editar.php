...
<body class="layout-4">
                    ...
                    <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="lista.php" class="">Lista de servicios</a></li>
                                    <li class=""><a href="agregar.php" class="">Agregar servicio</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="lista.php">Servicios</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void">Editar servicio</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                <!-- content here -->
                                                <h2 class="my-4">Editar servicio</h2>
                                                <div id="mensaje"></div>
                                                <form id="form-editar">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="nombre" class="form-control-label">Icono <span class="text-danger">*</span></label>
                                                        <div class="d-flex">
                                                            <div class="w-100 mr-2">
                                                                <input type="text" name="icono" id="icono" class="form-control">
                                                            </div>
                                                            <div class="">
                                                                <button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal-iconos">Buscar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="nombre" class="form-control-label">Color <span class="text-danger">*</span></label>
                                                        <select name="color" id="color" class="form-control">
                                                            <option value="" selected disabled>Selecciona una opcion</option>
                                                            <option value="0">Verder</option>
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-primary btn-block py-3">Actualizar</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
   ...
   <script>
       ...
       axios.get('../../server/servicios.php', {
           params: {
               id: id
           }
       })
        .then(res => {
            ...
            document.getElementById('icono').value = res.data.icono;
            document.getElementById('descripcion').value = res.data.descripcion;
            let colors = ['text-success', 'text-primary', 'text-orange', 'text-danger'];
            let index = colors.indexOf(res.data.color);
            $('#color').val(index).change();
        })
        ...
        document.getElementById('form-editar').addEventListener('submit', function (e) {
            ...
            form.append('icono', icono.value);
            form.append('color', color.value);
            form.append('descripcion', descripcion);
            form.append('id', id.value);
            form.append('accion', 'editar');

            axios.post('../../server/servicios.php', form)
                .then(res => {

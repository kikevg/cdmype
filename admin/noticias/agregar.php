...
<body class="layout-4">
                    ...
                    <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="lista.php" class="">Lista de noticias</a></li>
                                    <li class=""><a href="agregar.php" class="">Agregar noticia</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="lista.php">Noticias</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void">Agregar noticia</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-sm 12 col-lg-8">
                                                                <label for="nombre" class="form-control-label">Titulo <span class="text-danger">*</span></label>
                                                                <input type="text" name="titulo" id="titulo" class="form-control">
                                                            </div>
                                                            <div class="col-sm 12 col-lg-4">
                                                                <label for="nombre" class="form-control-label">Categoria <span class="text-danger">*</span></label>
   ...
   <script>
        ...
        document.getElementById('form-agregar').addEventListener('submit', function (e) {
            ...
            axios.post('../../server/noticias.php', form, {

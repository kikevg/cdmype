                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void">Servicios</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                <!-- content here -->
                                                <h2 class="my-4">Lista de servicios</h2>
                                                <div id="mensaje"></div>
                    ...
                    data.forEach((s, i) => {
                        str += `
                            <tr>
                                ...
                                <td class="w-25">
                                    <div class="btn-group"> 
                                        <a href="editar.php?id=${s.id}" class="btn btn-light">
                                            <i class="feather icon-edit text-dark p-0 m-0"></i>
                                        </a>

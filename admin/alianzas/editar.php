                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void">Editar alianza</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                <!-- content here -->
                                                <h2 class="my-4">Editar alianza</h2>
                                                <div id="mensaje"></div>
                                                <div id="mensaje"></div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12 col-lg-7">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <p>Si desesas cambiar la imagen, selecciona una desde tus archivos</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">

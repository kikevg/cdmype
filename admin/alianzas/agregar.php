...
<body class="layout-4">
                    ...
                    <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="lista.php" class="">Lista de alianzas</a></li>
                                    <li class=""><a href="agregar.php" class="">Agregar alianza</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="lista.php">Alianzas</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void">Agregar alianza</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                <!-- content here -->
                                                <h2 class="my-4">Agregar alianza</h2>
                                                <div id="mensaje"></div>
                                                <div id="mensaje"></div>
   ...
   <script>
        ...
        document.getElementById('form-agregar').addEventListener('submit', function (e) {
            ...
            axios.post('../../server/alianzas.php', form, {

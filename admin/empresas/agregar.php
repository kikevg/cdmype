                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void">Agregar empresa</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                <!-- content here -->
                                                <h2 class="my-4">Agregar empresa</h2>
                                                <div id="mensaje"></div>
                                                <div id="mensaje"></div>
        ...
        document.getElementById('form-agregar').addEventListener('submit', function (e) {
            ...
            axios.post('../../server/empresas.php', form, {
                ...
                .then(res => {
                    ...
                    document.querySelector('.custom-file-label').textContent = 'Elegir un archivo';

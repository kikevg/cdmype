...
<body class="layout-4">
                    ...
                    <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="lista.php" class="">Lista de empresas</a></li>
                                    <li class=""><a href="agregar.php" class="">Agregar empresa</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="lista.php">Empresas</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void">Editar empresa</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12 col-lg-7">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <p>Si deseas cambiar la imagen, selecciona una desde tus archivos</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-2">
                                                                <label for="fundacion" class="form-control-label">Fundacion <span class="text-danger">*</span></label>
                                                                <input type="text" name="fundacion" id="fundacion" class="form-control" placeholder="2007">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="nombre" class="form-control-label">Propietario <span class="text-danger">*</span></label>
                                                        <input type="text" name="propietario" id="propietario" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="nombre" class="form-control-label">Sito web</label>
   ...
   <script>
        ...
        .then(res => {
            ...
            document.getElementById('fundacion').value = res.data.fundacion;
            document.getElementById('propietario').value = res.data.propietario;
        ...
        document.getElementById('form-editar').addEventListener('submit', function (e) {
            ...
            axios.post('../../server/empresas.php', form, {

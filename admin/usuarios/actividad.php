...
<body class="layout-4">
                        ...
                        <div class="page-block">
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void"><i class="feather icon-home"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="page-block">
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="javascrip:void"><i class="feather icon-home"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="m-auto" style="max-width: 650px">
                                                ...
                                                <div class="card latest-update-card">
                                                    ...
                                                    <div class="latest-scroll">
                                                        <div class="card-body">
                                                            <div class="latest-update-box" id="actividades">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
   ...
   <script>
       ...
       axios.get('../../server/log.php', { params: { idusuariologs: id }})
        .then(res => {
            ...
            res.data.forEach(l => {
                str += `
                    <div class="row pb-2 pt-2">
                        ...
                        <div class="col p-l-5">
                            <h6 class="m-0">${l.descripcion}</h6>
                            <p class="m-b-0">${l.usuario} - ${l.fecha}</p>
                        </div>
                    </div>
                `;
            });

            document.getElementById('actividades').innerHTML = str;

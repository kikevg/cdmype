                    ...
                    <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li data-username="Menu levels Menu level 2.1 Menu level 2.2" class="nav-item pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class=""><a href="lista.php" class="">Lista de usuarios</a></li>
                                    <li class=""><a href="agregar.php" class="">Agregar usuario</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void">Usuarios</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                <li><a href="perfil.php?id=<?php echo $_SESSION['usuario']['id'] ?>" class="dropdown-item"><i class="feather icon-user"></i> Perfil</a></li>
                                <li><a href="config.php?id=<?php echo $_SESSION['usuario']['id'] ?>" class="dropdown-item"><i class="feather icon-settings"></i> Configuraciones</a></li>
                                <li><a href="actividad.php?id=<?php echo $_SESSION['usuario']['id'] ?>" class="dropdown-item"><i class="feather icon-sidebar"></i> Mi actividad</a></li>
                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="m-auto" style="min-height: 550px; max-width: 650px !important;">
                                                <!-- content here -->
                                                <h2 class="my-4">Configuraciones</h2>
                                                <div class="row flex-column flex-md-row">
                                                    <div class="col-sm-12 col-md-3">
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                            <a class="nav-link active" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Perfil</a>
                                                            ...
                                                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Cuenta</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-9">
                                                        <div class="tab-content" id="v-pills-tabContent">
                                                            <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                                                ...
                                                                <form id="form-editar-usuario">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label for="old-clave">Nombre</label>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                                                <h4>Contraseña</h4>
                                                                <div id="msj"></div>
                                                                <form id="form-editar-clave">
                                                                    <div class="form-group">
                                                                        <input type="hidden" name="id" id="id-clave">
                                                                        <label for="old-clave">Contraseña</label>
                                                                        <input type="password" name="clave" id="clave" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="">Nueva contraseña</label>
                                                                        <input type="password" name="nuevaClave1" id="clave-1" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="">Repite la contraseña</label>
                                                                        <input type="password" name="nuevaClave2" id="clave-2" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <button type="submit" class="btn btn-primary">Guardar</button>
                                                                        <a href="perfil.php" class="btn btn-light">Cancelar</a>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                                                ...
                                                                <p>Si eliminas esta cuenta no podras volver a recuperarla. ¿Estás seguro de querer eliminarla?</p>
                                                                <form id="form-eliminar-cuenta">
                                                                    <input type="hidden" name="id" id="id-cuenta">
                                                                    <div class="form-group">
   ...
   <script>
        ...
        axios.get('../../server/usuarios.php', {
            ...
            .then(res => {
                ...
                document.getElementById('id-clave').value = res.data.id;
                document.getElementById('id-cuenta').value = res.data.id;
                document.getElementById('nombre').value = res.data.nombre;
                document.getElementById('email').value = res.data.email;
                document.getElementById('usuario').value = res.data.usuario;
        ...
        document.getElementById('form-editar-usuario').addEventListener('submit', function (e) {
            ...
            form.append('accion', 'editar_usuario');

            axios.post('../../server/usuarios.php', form)
                .then(res => {
        ...
        document.getElementById('form-editar-clave').addEventListener('submit', function (e) {
            e.preventDefault();
            ...
            let form = new FormData(this);
            form.append('accion', 'editar_clave')
            axios.post('../../server/usuarios.php', form)
                .then(res => {

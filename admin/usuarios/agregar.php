                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="lista.php">Usuarios</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void">Agregar usuario</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                ...
                                                <form id="form-agregar">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="nombre" class="form-control-label">Email <span class="text-danger">*</span></label>
                                                        <input type="text" name="email" id="email" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-lg-6">
                                                                <label for="nombre" class="form-control-label">Usuario <span class="text-danger">*</span></label>
                                                                <input type="text" name="usuario" id="usuario" class="form-control">
                                                            </div>
                                                            <div class="col-sm-12 col-lg-6">
                                                                <label for="nombre" class="form-control-label">Contraseña <span class="text-danger">*</span></label>

                                            ...
                                            <div class="m-auto" style="max-width: 650px !important;">
                                                ...
                                                <div class="card">
                                                    <div class="card-body text-center">
                                                        <div class="bg-primary d-flex align-items-center justify-content-center rounded-circle m-auto" style="height: 120px; width: 120px">
   ...
   <script>
        ...
        axios.get('../../server/usuarios.php', {
            ...
            .then(res => {
                ...
                document.getElementById('nombre').textContent = res.data.nombre;
                document.getElementById('email').textContent = res.data.email;
                document.getElementById('usuario').textContent = res.data.usuario;
            })
